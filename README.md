...
Free, lightweight desktop utilities for everyday productivity — sticky notes that float on your desktop, and always-visible timers. Each one is designed to stay out of your way while keeping what matters in sight, and ships with automated cross-platform builds (Windows + macOS) via GitHub Actions.
...
├── .github/workflows/   # CI/CD builds for both apps
