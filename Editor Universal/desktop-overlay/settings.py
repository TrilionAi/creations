"""
Settings - Gerenciamento de configurações do Editor Universal Desktop
Salva em %APPDATA%/Editor Universal quando empacotado, ou no diretório do script em dev.
"""
...
def _get_config_dir():
    ...
    if getattr(sys, 'frozen', False):
        # Executável empacotado → AppData
        appdata = os.environ.get('APPDATA', os.path.expanduser('~'))
        config_dir = os.path.join(appdata, APP_NAME)
        os.makedirs(config_dir, exist_ok=True)

        # Migração: copiar settings.json antigo do dir do exe
        ...
        # Desenvolvimento → diretório do script
