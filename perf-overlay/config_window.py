"""
Config Window - Overlay settings window
Allows adjusting font, temperature limits, colors, and auto-start
"""
...
DEFAULT_SETTINGS = {
    ...
    'color_temp': '#00AAFF',        # Light blue
    'color_background': '#1E1E1E',  # Dark gray
    # Hotkeys (virtual keys)
...
def set_auto_start(enabled):
    """Configures auto-start with the system"""
...
class HotkeyButton(QPushButton):
    ...
    def update_text(self):
        if self.waiting:
            ...
            self.setText(self.hotkey.upper() if self.hotkey else "None")
...
class ColorButton(QPushButton):
    ...
    def choose_color(self):
        color = QColorDialog.getColor(QColor(self.color), self, "Choose a color")
        if color.isValid():
...
class ConfigWindow(QWidget):
    ...
    def init_ui(self):
        ...
        self.setWindowTitle("Settings - Performance Status")
        ...
        normal_label = QLabel("Normal Usage (low):")
        ...
        warning_label = QLabel("Medium Usage (warning):")
        ...
        critical_label = QLabel("High Usage (critical):")
        ...
        temp_label = QLabel("Normal Temperature:")
        ...
        temp_group = QGroupBox("Temperature Alerts")
        temp_group_layout = QVBoxLayout()

        # CPU Limit
        cpu_layout = QHBoxLayout()
        cpu_label = QLabel("CPU Limit (°C):")
        ...
        hotkeys_group = QGroupBox("Keyboard Shortcuts (click to change)")
        hotkeys_layout = QVBoxLayout()

        # Toggle visibility
        toggle_layout = QHBoxLayout()
        toggle_label = QLabel("Show/Hide:")
        ...
        quit_label = QLabel("Close Application:")
        ...
        config_label = QLabel("Open Settings:")
