"""
Config Window - Settings window for Universal Editor Desktop
Allows adjusting hotkeys, colors, thickness and reading guide
HotkeyButton and ColorButton widgets reused from Performance Status
"""
...
class HotkeyButton(QPushButton):
    ...
    def _update_text(self):
        self.setText("Press a key..." if self.waiting
                     else (self.hotkey.upper() if self.hotkey else "None"))
...
class ConfigWindow(QWidget):
    ...
    def _init_ui(self):
        self.setWindowTitle("Settings - Universal Editor")
        ...
        hotkey_items = [
            ('hotkey_toggle_draw', 'Draw Mode:'),
            ('hotkey_toggle_guide', 'Reading Guide:'),
            ('hotkey_toggle_text', 'Text Mode:'),
            ('hotkey_quit', 'Close App:'),
        ]
        ...
        size_row.addWidget(QLabel("Default Thickness:"))
        size_row.addStretch()
        ...
        # --- Reading Guide ---
        guide_group = QGroupBox("Reading Guide")
        guide_layout = QVBoxLayout()

        height_row = QHBoxLayout()
        height_row.addWidget(QLabel("Bar Height:"))
